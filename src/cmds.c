...
#define CMDS(X)                                                                \
  ...
  X(JOIN, const List2 channels[])                                              \
  X(PART, const List2 channels[], const char *message)                         \
  X(MODE, const char *channel, const char **modes, const char **modeparams)    \
  X(TOPIC, const char *channel, const char *topic)                             \
  X(NAMES, const List2 channels[], const char *target)                         \
  X(LIST, const List2 channels[], const char *target)                          \
  X(INVITE, const char *nickname, const char *channel)                         \
  X(KICK, const List2 channels[], const List2 users[], char *comment)          \
  ...
  X(WHOIS, const char *target, const List2 masks[])                            \
  X(WHOWAS, const List2 nicknames[], int count, const char *target)            \
  ...
  X(USERHOST, const List2 nicknames[])                                         \
  X(ISON, const List2 nicknames[])
...
const char *string2CMD(const char *cmd) {
#define s2C(c, a...) \
...
int cmdJOIN(const List2 channels[]...) { return 0; }

int cmdPART(const List2 channels[], const char *message...) { return 0; }

int cmdMODE(const char *channel, const char **modes,
...
int cmdNAMES(const List2 channels[], const char *target...) { return 0; }

int cmdLIST(const List2 channels[], const char *target...) { return 0; }

int cmdINVITE(const char *nickname, const char *channel...) { return 0; }

int cmdKICK(const List2 channels[], const List2 users[], char *comment...) {
  return 0;
}
...
int cmdLINKS(const char *remote_server, const char *server_mask...) {
  return 0;
}

int cmdTIME(const char *target...) { return 0; }

int cmdCONNECT(const char *target_server, int port,
...
int cmdWHOIS(const char *target, const List2 masks[]...) { return 0; }

int cmdWHOWAS(const List2 nicknames[], int count, const char *target...) {
  return 0;
}
...
int cmdUSERHOST(const List2 nicknames[]...) { return 0; }

int cmdISON(const List2 nicknames[]...) { return 0; }
